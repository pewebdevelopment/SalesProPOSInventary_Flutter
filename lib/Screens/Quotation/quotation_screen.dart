...
class QuotationScreen extends StatefulWidget {
  QuotationScreen({Key? key,@required this.catName}) : super(key: key);
  var catName;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            GestureDetector(
              onTap: () {
                QuotationDetails().launch(context);
              },
              child: Container(
                height: 60.0,
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        QuotationCategory().launch(context);
                      },
                      child: Row(
                        children: [
                          SizedBox(
            ...
            ButtonGlobal(
              ...
              buttontext: 'Quotation List',
              iconColor: Colors.white,
              buttonDecoration: kButtonDecoration.copyWith(color: kMainColor),
              onPressed: (){
                QuotationList().launch(context);
              },
            ),
          ],
        ),
